...
!
! Fortran already has powerful validation capabilities. For example, Logical
! procedures ANY(3f) and ALL(3f) are standard Fortran features that easily
! allow performing the most common validations for command line arguments
...
! word) or contain characters special to the shell you have to
